...
export const REQUIRED_REPO_FAMILY_SEAM_OVERCLAIM_CASES = Object.freeze([
  ...
  "repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_operator_decision_or_intake",
  "repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_compliance_acceptance_or_result_truth",
  "repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_repair_success_or_agent_correctness",
  "repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_payload_or_layer_truth",
  "repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_application_merge_mutation_or_storage",
  "repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_dispatch_execution_authority_or_auto_execute",
  "repo_agent_repaired_outbox_report_result_intake_candidate_tui_treated_as_action_authority",
  "repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_observation_or_intake",
  "repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_compliance_acceptance_or_result_truth",
  "repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_repair_success_or_agent_correctness",
  "repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_payload_or_layer_truth",
  "repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_application_merge_mutation_or_storage",
  "repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_dispatch_execution_authority_or_auto_execute",
  "repo_agent_repaired_outbox_report_result_intake_operator_decision_tui_treated_as_action_authority",
  "repo_agent_repaired_outbox_report_result_intake_observation_treated_as_compliance_acceptance_or_result_truth",
  "repo_agent_repaired_outbox_report_result_intake_observation_treated_as_repair_success_or_agent_correctness",
  "repo_agent_repaired_outbox_report_result_intake_observation_treated_as_payload_or_layer_truth",
  "repo_agent_repaired_outbox_report_result_intake_observation_treated_as_application_merge_mutation_or_storage",
  "repo_agent_repaired_outbox_report_result_intake_observation_treated_as_dispatch_execution_authority_or_auto_execute",
  "repo_agent_repaired_outbox_report_result_intake_observation_tui_treated_as_action_authority",
  "repo_agent_repaired_outbox_report_loop_summary_treated_as_acceptance_or_truth",
  "repo_agent_repaired_outbox_report_loop_summary_treated_as_repair_success_or_agent_correctness",
  "repo_agent_repaired_outbox_report_loop_summary_treated_as_payload_layer_or_mutation",
  "repo_agent_repaired_outbox_report_loop_summary_treated_as_dispatch_execution_authority_or_auto_execute",
  "repo_agent_repaired_outbox_report_loop_summary_tui_treated_as_action_authority",
  "repaired_outbox_report_result_intake_loop_summary_treated_as_acceptance_or_truth",
  "repaired_outbox_report_result_intake_loop_summary_treated_as_repair_success_or_agent_correctness",
  "repaired_outbox_report_result_intake_loop_summary_treated_as_payload_layer_or_mutation",
  "repaired_outbox_report_result_intake_loop_summary_treated_as_dispatch_execution_authority_or_auto_execute",
  "repaired_outbox_report_result_intake_loop_summary_tui_treated_as_action_authority",
  "tui_mediated_local_seat_loop_with_repair_readiness_treated_as_acceptance_or_truth",
  "tui_mediated_local_seat_loop_with_repair_readiness_treated_as_repair_success_or_agent_correctness",
  "tui_mediated_local_seat_loop_with_repair_readiness_treated_as_payload_layer_or_mutation",
...
const REQUIRED_CASES = Object.freeze([
  ...
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_operator_decision_or_intake",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake candidate treated as operator decision creation/capture, approval, result-intake observation/result creation, result intake, or result-intake performance",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_operator_decision_or_intake"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_compliance_acceptance_or_result_truth",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake candidate treated as compliance acceptance, result acceptance, reported result truth, report body truth, or accepted continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_compliance_acceptance_or_result_truth"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_repair_success_or_agent_correctness",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake candidate treated as repair success truth, external agent correctness proof, report correctness proof, full Edge enclosure proof, or delivery/read/execution proof",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_repair_success_or_agent_correctness"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_payload_or_layer_truth",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake candidate treated as payload validity, payload fetch, payload materialization, Layer truth, or Layer continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_payload_or_layer_truth"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_application_merge_mutation_or_storage",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake candidate treated as result application, merge, repo mutation, Layer mutation, or storage write",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_application_merge_mutation_or_storage"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_dispatch_execution_authority_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake candidate treated as scheduling, launch, agent invocation, dispatch, execution, Platform call, host-local consequence, authority transition, event-family expansion, or auto-execute",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_candidate_treated_as_dispatch_execution_authority_or_auto_execute"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_candidate_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake candidate TUI projection treated as action authority, operator decision authority, result-intake action, compliance acceptance authority, mutation authority, dispatch authority, or execution authority",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_candidate_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_observation_or_intake",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake operator decision treated as result-intake observation/result creation, result intake, or result-intake performance",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_observation_or_intake"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_compliance_acceptance_or_result_truth",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake operator decision treated as compliance acceptance, result acceptance, reported result truth, report body truth, or accepted continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_compliance_acceptance_or_result_truth"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_repair_success_or_agent_correctness",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake operator decision treated as repair success truth, external agent correctness proof, report correctness proof, full Edge enclosure proof, or delivery/read/execution proof",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_repair_success_or_agent_correctness"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_payload_or_layer_truth",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake operator decision treated as payload validity, payload fetch, payload materialization, Layer truth, or Layer continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_payload_or_layer_truth"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_application_merge_mutation_or_storage",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake operator decision treated as result application, merge, repo mutation, Layer mutation, or storage write",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_application_merge_mutation_or_storage"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_dispatch_execution_authority_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake operator decision treated as scheduling, launch, agent invocation, dispatch, execution, Platform call, host-local consequence, authority transition, event-family expansion, or auto-execute",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_operator_decision_treated_as_dispatch_execution_authority_or_auto_execute"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_operator_decision_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake operator decision TUI projection treated as action authority, result-intake action, compliance acceptance authority, mutation authority, dispatch authority, or execution authority",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_operator_decision_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_observation_treated_as_compliance_acceptance_or_result_truth",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake observation/result treated as compliance acceptance, result acceptance, reported result truth, report body truth, or accepted continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_observation_treated_as_compliance_acceptance_or_result_truth"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_observation_treated_as_repair_success_or_agent_correctness",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake observation/result treated as repair success truth, external agent correctness proof, report correctness proof, full Edge enclosure proof, or delivery/read/execution proof",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_observation_treated_as_repair_success_or_agent_correctness"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_observation_treated_as_payload_or_layer_truth",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake observation/result treated as payload validity, payload fetch, payload materialization, Layer truth, or Layer continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_observation_treated_as_payload_or_layer_truth"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_observation_treated_as_application_merge_mutation_or_storage",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake observation/result treated as result application, merge, repo mutation, Layer mutation, or storage write",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_observation_treated_as_application_merge_mutation_or_storage"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_observation_treated_as_dispatch_execution_authority_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake observation/result treated as scheduling, launch, agent invocation, dispatch, execution, Platform call, host-local consequence, authority transition, event-family expansion, or auto-execute",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_observation_treated_as_dispatch_execution_authority_or_auto_execute"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_observation_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake observation/result TUI projection treated as action authority, compliance acceptance authority, mutation authority, dispatch authority, or execution authority",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_observation_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_loop_summary_treated_as_acceptance_or_truth",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report loop summary treated as compliance acceptance, result acceptance, reported result truth, report body truth, accepted continuity, or loop truth",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_loop_summary_treated_as_acceptance_or_truth"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_loop_summary_treated_as_repair_success_or_agent_correctness",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report loop summary treated as repair success truth, external agent correctness proof, report correctness proof, or full Edge enclosure proof",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_loop_summary_treated_as_repair_success_or_agent_correctness"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_loop_summary_treated_as_payload_layer_or_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report loop summary treated as payload validity, payload fetch, payload materialization, result application, merge, repo mutation, Layer mutation, Layer truth, Layer continuity, or storage write",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_loop_summary_treated_as_payload_layer_or_mutation"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_loop_summary_treated_as_dispatch_execution_authority_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report loop summary treated as scheduling, launch, agent invocation, dispatch, execution, Platform call, host-local consequence, authority transition, event-family expansion, or auto-execute",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_loop_summary_treated_as_dispatch_execution_authority_or_auto_execute"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_loop_summary_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report loop summary TUI or board visibility treated as action authority, acceptance authority, mutation authority, dispatch authority, or execution authority",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_loop_summary_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "repaired_outbox_report_result_intake_loop_summary_treated_as_acceptance_or_truth",
    sourceFamily: "edge",
    attemptedOverclaim: "Repaired outbox report result-intake loop summary treated as compliance acceptance, result acceptance, reported result truth, report body truth, repaired report truth, accepted continuity, or result truth",
    reasonCode: "blocked_case:repaired_outbox_report_result_intake_loop_summary_treated_as_acceptance_or_truth"
  }),
  Object.freeze({
    caseId: "repaired_outbox_report_result_intake_loop_summary_treated_as_repair_success_or_agent_correctness",
    sourceFamily: "edge",
    attemptedOverclaim: "Repaired outbox report result-intake loop summary treated as repair success truth, external agent correctness proof, report correctness proof, or full Edge enclosure proof",
    reasonCode: "blocked_case:repaired_outbox_report_result_intake_loop_summary_treated_as_repair_success_or_agent_correctness"
  }),
  Object.freeze({
    caseId: "repaired_outbox_report_result_intake_loop_summary_treated_as_payload_layer_or_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Repaired outbox report result-intake loop summary treated as payload validity, payload fetch, payload materialization, result application, merge, repo mutation, Layer mutation, Layer truth, Layer continuity, or storage write",
    reasonCode: "blocked_case:repaired_outbox_report_result_intake_loop_summary_treated_as_payload_layer_or_mutation"
  }),
  Object.freeze({
    caseId: "repaired_outbox_report_result_intake_loop_summary_treated_as_dispatch_execution_authority_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Repaired outbox report result-intake loop summary treated as scheduling, launch, agent invocation, dispatch, execution, Platform call, host-local consequence, authority transition, event-family expansion, or auto-execute",
    reasonCode: "blocked_case:repaired_outbox_report_result_intake_loop_summary_treated_as_dispatch_execution_authority_or_auto_execute"
  }),
  Object.freeze({
    caseId: "repaired_outbox_report_result_intake_loop_summary_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Repaired outbox report result-intake loop summary TUI or board visibility treated as action authority, acceptance authority, mutation authority, dispatch authority, or execution authority",
    reasonCode: "blocked_case:repaired_outbox_report_result_intake_loop_summary_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "tui_mediated_local_seat_loop_with_repair_readiness_treated_as_acceptance_or_truth",
    sourceFamily: "edge",
    attemptedOverclaim: "TUI-mediated local seat loop with repair readiness treated as compliance acceptance, result acceptance, report truth, repaired report truth, accepted continuity, or result truth",
    reasonCode: "blocked_case:tui_mediated_local_seat_loop_with_repair_readiness_treated_as_acceptance_or_truth"
  }),
  Object.freeze({
    caseId: "tui_mediated_local_seat_loop_with_repair_readiness_treated_as_repair_success_or_agent_correctness",
    sourceFamily: "edge",
    attemptedOverclaim: "TUI-mediated local seat loop with repair readiness treated as repair success proof, external agent correctness proof, delivery/read proof, or report correctness proof",
    reasonCode: "blocked_case:tui_mediated_local_seat_loop_with_repair_readiness_treated_as_repair_success_or_agent_correctness"
  }),
  Object.freeze({
    caseId: "tui_mediated_local_seat_loop_with_repair_readiness_treated_as_payload_layer_or_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "TUI-mediated local seat loop with repair readiness treated as payload validity, payload fetch, payload materialization, result application, merge, repo mutation, Layer mutation, Layer truth, Layer continuity, or storage write",
    reasonCode: "blocked_case:tui_mediated_local_seat_loop_with_repair_readiness_treated_as_payload_layer_or_mutation"
  }),
  Object.freeze({
    caseId: "tui_mediated_local_seat_loop_with_repair_readiness_treated_as_dispatch_execution_authority_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "TUI-mediated local seat loop with repair readiness treated as scheduling, runner creation, launch, agent invocation, dispatch, execution, Platform call, host-local consequence, authority transition, event-family expansion, or auto-execute",
    reasonCode: "blocked_case:tui_mediated_local_seat_loop_with_repair_readiness_treated_as_dispatch_execution_authority_or_auto_execute"
  }),
  Object.freeze({
    caseId: "tui_mediated_local_seat_loop_with_repair_readiness_treated_as_enclosure_or_autonomy_proof",
    sourceFamily: "edge",
    attemptedOverclaim: "TUI-mediated local seat loop with repair readiness treated as full Edge enclosure proof, autonomy proof, default authority, or Edge control of external repo-agent behavior",
    reasonCode: "blocked_case:tui_mediated_local_seat_loop_with_repair_readiness_treated_as_enclosure_or_autonomy_proof"
  }),
  Object.freeze({
    caseId: "tui_mediated_local_seat_loop_with_repair_readiness_tui_treated_as_action_authority",
    sourceFamily: "edge",
  ...
  Object.freeze({
    caseId: "edge_node_capability_profile_treated_as_endpoint_or_network_service",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node capability profile treated as endpoint creation, network service startup, transport, inbox write, outbox import, report import, or live endpoint behavior",
    reasonCode: "blocked_case:edge_node_capability_profile_treated_as_endpoint_or_network_service"
  }),
  Object.freeze({
    caseId: "edge_node_capability_profile_treated_as_identity_admission_or_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node capability profile treated as identity authority, seat admission, authority transition, accepted continuity, or Layer continuity",
    reasonCode: "blocked_case:edge_node_capability_profile_treated_as_identity_admission_or_authority"
  }),
  Object.freeze({
    caseId: "edge_node_capability_profile_treated_as_report_truth_result_acceptance_or_payload_validity",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node capability profile treated as report truth, result truth, result acceptance, payload validity, payload fetch, payload materialization, result application, or merge",
    reasonCode: "blocked_case:edge_node_capability_profile_treated_as_report_truth_result_acceptance_or_payload_validity"
  }),
  Object.freeze({
    caseId: "edge_node_capability_profile_treated_as_repo_layer_storage_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node capability profile treated as repo mutation, Layer mutation, Layer truth, storage write, or production storage authority",
    reasonCode: "blocked_case:edge_node_capability_profile_treated_as_repo_layer_storage_mutation"
  }),
  Object.freeze({
    caseId: "edge_node_capability_profile_treated_as_scheduler_dispatch_execution_or_platform",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node capability profile treated as scheduler, runner, repo-agent invocation, dispatch, execution, Platform call, host-local consequence, or activation",
    reasonCode: "blocked_case:edge_node_capability_profile_treated_as_scheduler_dispatch_execution_or_platform"
  }),
  Object.freeze({
    caseId: "edge_node_capability_profile_treated_as_full_enclosure_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node capability profile treated as full Edge enclosure proof, autonomy proof, event-family expansion, or auto-execute",
    reasonCode: "blocked_case:edge_node_capability_profile_treated_as_full_enclosure_or_auto_execute"
  }),
  Object.freeze({
    caseId: "edge_node_capability_profile_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node capability profile TUI projection treated as action authority, endpoint authority, mutation authority, dispatch authority, execution authority, or approval",
    reasonCode: "blocked_case:edge_node_capability_profile_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "edge_node_profile_readiness_candidate_treated_as_endpoint_implementation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node profile readiness candidate treated as endpoint implementation, endpoint creation, network service startup, transport, inbox write, outbox import, or live endpoint behavior",
    reasonCode: "blocked_case:edge_node_profile_readiness_candidate_treated_as_endpoint_implementation"
  }),
  Object.freeze({
    caseId: "edge_node_profile_readiness_candidate_treated_as_identity_admission_or_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node profile readiness candidate treated as identity authority, seat admission, authority transition, accepted continuity, or Layer continuity",
    reasonCode: "blocked_case:edge_node_profile_readiness_candidate_treated_as_identity_admission_or_authority"
  }),
  Object.freeze({
    caseId: "edge_node_profile_readiness_candidate_treated_as_report_truth_result_acceptance_or_payload_validity",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node profile readiness candidate treated as report truth, result truth, result acceptance, payload validity, payload fetch, payload materialization, result application, or merge",
    reasonCode: "blocked_case:edge_node_profile_readiness_candidate_treated_as_report_truth_result_acceptance_or_payload_validity"
  }),
  Object.freeze({
    caseId: "edge_node_profile_readiness_candidate_treated_as_repo_layer_storage_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node profile readiness candidate treated as repo mutation, Layer mutation, Layer truth, storage write, or production storage authority",
    reasonCode: "blocked_case:edge_node_profile_readiness_candidate_treated_as_repo_layer_storage_mutation"
  }),
  Object.freeze({
    caseId: "edge_node_profile_readiness_candidate_treated_as_scheduler_dispatch_execution_or_platform",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node profile readiness candidate treated as scheduler, runner, repo-agent invocation, dispatch, execution, Platform call, host-local consequence, or activation",
    reasonCode: "blocked_case:edge_node_profile_readiness_candidate_treated_as_scheduler_dispatch_execution_or_platform"
  }),
  Object.freeze({
    caseId: "edge_node_profile_readiness_candidate_treated_as_full_enclosure_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node profile readiness candidate treated as full Edge enclosure proof, autonomy proof, event-family expansion, implementation authority, or auto-execute",
    reasonCode: "blocked_case:edge_node_profile_readiness_candidate_treated_as_full_enclosure_or_auto_execute"
  }),
  Object.freeze({
    caseId: "edge_node_profile_readiness_candidate_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node profile readiness candidate TUI projection treated as action authority, endpoint implementation authority, mutation authority, dispatch authority, execution authority, or approval",
    reasonCode: "blocked_case:edge_node_profile_readiness_candidate_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "edge_node_profile_implementation_candidate_treated_as_implementation_or_endpoint",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node profile implementation candidate treated as implementation, node profile runtime, endpoint implementation, endpoint creation, network service startup, port binding, transport, inbox write, outbox import, result intake, or live endpoint behavior",
    reasonCode: "blocked_case:edge_node_profile_implementation_candidate_treated_as_implementation_or_endpoint"
  }),
  Object.freeze({
    caseId: "edge_node_profile_implementation_candidate_treated_as_identity_admission_or_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node profile implementation candidate treated as identity authority, seat admission, authority transition, accepted continuity, or Layer continuity",
    reasonCode: "blocked_case:edge_node_profile_implementation_candidate_treated_as_identity_admission_or_authority"
  }),
  Object.freeze({
    caseId: "edge_node_profile_implementation_candidate_treated_as_report_truth_result_acceptance_or_payload_validity",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node profile implementation candidate treated as report truth, result truth, result acceptance, payload validity, payload fetch, payload materialization, result application, or merge",
    reasonCode: "blocked_case:edge_node_profile_implementation_candidate_treated_as_report_truth_result_acceptance_or_payload_validity"
  }),
  Object.freeze({
    caseId: "edge_node_profile_implementation_candidate_treated_as_repo_layer_storage_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node profile implementation candidate treated as repo mutation, Layer mutation, Layer truth, storage write, or production storage authority",
    reasonCode: "blocked_case:edge_node_profile_implementation_candidate_treated_as_repo_layer_storage_mutation"
  }),
  Object.freeze({
    caseId: "edge_node_profile_implementation_candidate_treated_as_scheduler_dispatch_execution_or_platform",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node profile implementation candidate treated as scheduler, runner, repo-agent invocation, dispatch, execution, Platform call, host-local consequence, or activation",
    reasonCode: "blocked_case:edge_node_profile_implementation_candidate_treated_as_scheduler_dispatch_execution_or_platform"
  }),
  Object.freeze({
    caseId: "edge_node_profile_implementation_candidate_treated_as_full_enclosure_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge node profile implementation candidate treated as full Edge enclosure proof, autonomy proof, event-family expansion, implementation authority, or auto-execute",
    reasonCode: "blocked_case:edge_node_profile_implementation_candidate_treated_as_full_enclosure_or_auto_execute"
  }),
  Object.freeze({
    caseId: "edge_node_profile_implementation_candidate_tui_treated_as_action_authority",
    sourceFamily: "edge",
  ...
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_candidate_treated_as_runtime_endpoint_or_transport",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation candidate treated as runtime implementation, endpoint implementation, endpoint service, HTTP server, CLI command, watcher, network service, port binding, transport, inbox write, outbox import, result intake, or live endpoint behavior",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_candidate_treated_as_runtime_endpoint_or_transport"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_candidate_treated_as_report_truth_acceptance_or_payload_validity",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation candidate treated as report truth, result truth, result acceptance, payload validity, payload fetch, payload materialization, result application, or merge",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_candidate_treated_as_report_truth_acceptance_or_payload_validity"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_candidate_treated_as_repo_layer_storage_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation candidate treated as repo mutation, Layer mutation, Layer truth, storage write, or production storage authority",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_candidate_treated_as_repo_layer_storage_mutation"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_candidate_treated_as_scheduler_dispatch_execution_or_platform",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation candidate treated as scheduler, runner, repo-agent invocation, dispatch, execution, Platform call, host-local consequence, or activation",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_candidate_treated_as_scheduler_dispatch_execution_or_platform"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_candidate_treated_as_authority_enclosure_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation candidate treated as identity authority, seat admission, authority transition, accepted continuity, full Edge enclosure proof, autonomy proof, event-family expansion, implementation authority, or auto-execute",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_candidate_treated_as_authority_enclosure_or_auto_execute"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_candidate_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation candidate TUI projection treated as action authority, endpoint implementation authority, mutation authority, dispatch authority, execution authority, or approval",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_candidate_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_decision_treated_as_planning_observation_or_runtime",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation operator decision treated as runtime implementation planning observation/result, runtime implementation plan, runtime implementation, endpoint implementation, endpoint service, HTTP server, CLI command, watcher, network service, port binding, transport, inbox write, outbox import, result intake, or live endpoint behavior",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_decision_treated_as_planning_observation_or_runtime"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_decision_treated_as_report_truth_acceptance_or_payload_validity",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation operator decision treated as report truth, result truth, result acceptance, payload validity, payload fetch, payload materialization, result application, or merge",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_decision_treated_as_report_truth_acceptance_or_payload_validity"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_decision_treated_as_repo_layer_storage_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation operator decision treated as repo mutation, Layer mutation, Layer truth, storage write, or production storage authority",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_decision_treated_as_repo_layer_storage_mutation"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_decision_treated_as_scheduler_dispatch_execution_or_platform",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation operator decision treated as scheduler, runner, repo-agent invocation, dispatch, execution, Platform call, host-local consequence, or activation",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_decision_treated_as_scheduler_dispatch_execution_or_platform"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_decision_treated_as_authority_enclosure_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation operator decision treated as identity authority, seat admission, authority transition, accepted continuity, full Edge enclosure proof, autonomy proof, event-family expansion, implementation authority, or auto-execute",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_decision_treated_as_authority_enclosure_or_auto_execute"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_decision_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation operator decision TUI projection treated as action authority, runtime implementation authority, endpoint implementation authority, mutation authority, dispatch authority, execution authority, or approval",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_decision_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_planning_observation_treated_as_plan_or_runtime",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation planning observation/result treated as runtime implementation plan, runtime implementation, endpoint implementation, endpoint service, HTTP server, CLI command, watcher, network service, port binding, transport, inbox write, outbox import, result intake, or live endpoint behavior",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_planning_observation_treated_as_plan_or_runtime"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_planning_observation_treated_as_report_truth_acceptance_or_payload_validity",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation planning observation/result treated as report truth, result truth, result acceptance, payload validity, payload fetch, payload materialization, result application, or merge",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_planning_observation_treated_as_report_truth_acceptance_or_payload_validity"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_planning_observation_treated_as_repo_layer_storage_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation planning observation/result treated as repo mutation, Layer mutation, Layer truth, storage write, or production storage authority",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_planning_observation_treated_as_repo_layer_storage_mutation"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_planning_observation_treated_as_scheduler_dispatch_execution_or_platform",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation planning observation/result treated as scheduler, runner, repo-agent invocation, dispatch, execution, Platform call, host-local consequence, or activation",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_planning_observation_treated_as_scheduler_dispatch_execution_or_platform"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_planning_observation_treated_as_authority_enclosure_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation planning observation/result treated as identity authority, seat admission, authority transition, accepted continuity, full Edge enclosure proof, autonomy proof, event-family expansion, implementation authority, or auto-execute",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_planning_observation_treated_as_authority_enclosure_or_auto_execute"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_planning_observation_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation planning observation/result TUI projection treated as action authority, runtime implementation authority, endpoint implementation authority, mutation authority, dispatch authority, execution authority, or approval",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_planning_observation_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_candidate_treated_as_approved_plan_or_runtime",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan candidate treated as approved runtime implementation plan, runtime implementation, endpoint implementation, endpoint service, HTTP server, CLI command, watcher, network service, port binding, transport, inbox write, outbox import, result intake, or live endpoint behavior",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_candidate_treated_as_approved_plan_or_runtime"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_candidate_treated_as_report_truth_acceptance_or_payload_validity",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan candidate treated as report truth, result truth, result acceptance, payload validity, payload fetch, payload materialization, result application, or merge",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_candidate_treated_as_report_truth_acceptance_or_payload_validity"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_candidate_treated_as_repo_layer_storage_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan candidate treated as repo mutation, Layer mutation, Layer truth, storage write, or production storage authority",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_candidate_treated_as_repo_layer_storage_mutation"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_candidate_treated_as_scheduler_dispatch_execution_or_platform",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan candidate treated as scheduler, runner, repo-agent invocation, dispatch, execution, Platform call, host-local consequence, or activation",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_candidate_treated_as_scheduler_dispatch_execution_or_platform"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_candidate_treated_as_authority_enclosure_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan candidate treated as identity authority, seat admission, authority transition, accepted continuity, full Edge enclosure proof, autonomy proof, event-family expansion, implementation authority, or auto-execute",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_candidate_treated_as_authority_enclosure_or_auto_execute"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_candidate_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan candidate TUI projection treated as action authority, runtime implementation authority, endpoint implementation authority, mutation authority, dispatch authority, execution authority, or approval",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_candidate_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_decision_treated_as_preparation_observation_or_runtime",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan operator decision treated as preparation observation/result, runtime implementation preparation, runtime implementation, endpoint implementation, endpoint service, HTTP server, CLI command, watcher, network service, port binding, transport, inbox write, outbox import, result intake, or live endpoint behavior",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_decision_treated_as_preparation_observation_or_runtime"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_decision_treated_as_report_truth_acceptance_or_payload_validity",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan operator decision treated as report truth, result truth, result acceptance, payload validity, payload fetch, payload materialization, result application, or merge",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_decision_treated_as_report_truth_acceptance_or_payload_validity"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_decision_treated_as_repo_layer_storage_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan operator decision treated as repo mutation, Layer mutation, Layer truth, storage write, or production storage authority",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_decision_treated_as_repo_layer_storage_mutation"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_decision_treated_as_scheduler_dispatch_execution_or_platform",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan operator decision treated as scheduler, runner, repo-agent invocation, dispatch, execution, Platform call, host-local consequence, or activation",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_decision_treated_as_scheduler_dispatch_execution_or_platform"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_decision_treated_as_authority_enclosure_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan operator decision treated as identity authority, seat admission, authority transition, accepted continuity, full Edge enclosure proof, autonomy proof, event-family expansion, implementation authority, or auto-execute",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_decision_treated_as_authority_enclosure_or_auto_execute"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_decision_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan operator decision TUI projection treated as action authority, runtime implementation authority, endpoint implementation authority, mutation authority, dispatch authority, execution authority, or approval",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_decision_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_approval_observation_treated_as_preparation_or_runtime",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan approval observation/result treated as runtime implementation preparation, runtime implementation, endpoint implementation, endpoint service, HTTP server, CLI command, watcher, network service, port binding, transport, inbox write, outbox import, result intake, or live endpoint behavior",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_approval_observation_treated_as_preparation_or_runtime"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_approval_observation_treated_as_report_truth_acceptance_or_payload_validity",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan approval observation/result treated as report truth, result truth, result acceptance, payload validity, payload fetch, payload materialization, result application, or merge",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_approval_observation_treated_as_report_truth_acceptance_or_payload_validity"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_approval_observation_treated_as_repo_layer_storage_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan approval observation/result treated as repo mutation, Layer mutation, Layer truth, storage write, or production storage authority",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_approval_observation_treated_as_repo_layer_storage_mutation"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_approval_observation_treated_as_scheduler_dispatch_execution_or_platform",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan approval observation/result treated as scheduler, runner, repo-agent invocation, dispatch, execution, Platform call, host-local consequence, or activation",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_approval_observation_treated_as_scheduler_dispatch_execution_or_platform"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_approval_observation_treated_as_authority_enclosure_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan approval observation/result treated as identity authority, seat admission, authority transition, accepted continuity, full Edge enclosure proof, autonomy proof, event-family expansion, implementation authority, or auto-execute",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_approval_observation_treated_as_authority_enclosure_or_auto_execute"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_plan_approval_observation_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation plan approval observation/result TUI projection treated as action authority, runtime implementation authority, endpoint implementation authority, mutation authority, dispatch authority, execution authority, or approval",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_plan_approval_observation_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_candidate_treated_as_decision_or_preparation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation candidate treated as preparation operator decision, runtime implementation preparation, runtime implementation, endpoint implementation, endpoint service, HTTP server, CLI command, watcher, network service, port binding, transport, inbox write, outbox import, result intake, or live endpoint behavior",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_candidate_treated_as_decision_or_preparation"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_candidate_treated_as_report_truth_acceptance_or_payload_validity",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation candidate treated as report truth, result truth, result acceptance, payload validity, payload fetch, payload materialization, result application, or merge",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_candidate_treated_as_report_truth_acceptance_or_payload_validity"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_candidate_treated_as_repo_layer_storage_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation candidate treated as repo mutation, Layer mutation, Layer truth, storage write, or production storage authority",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_candidate_treated_as_repo_layer_storage_mutation"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_candidate_treated_as_scheduler_dispatch_execution_or_platform",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation candidate treated as scheduler, runner, repo-agent invocation, dispatch, execution, Platform call, host-local consequence, or activation",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_candidate_treated_as_scheduler_dispatch_execution_or_platform"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_candidate_treated_as_authority_enclosure_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation candidate treated as identity authority, seat admission, authority transition, accepted continuity, full Edge enclosure proof, autonomy proof, event-family expansion, implementation authority, or auto-execute",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_candidate_treated_as_authority_enclosure_or_auto_execute"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_candidate_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation candidate TUI projection treated as action authority, runtime implementation authority, endpoint implementation authority, mutation authority, dispatch authority, execution authority, or approval",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_candidate_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_decision_treated_as_preparation_observation_or_runtime",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation operator decision treated as preparation observation/result, runtime implementation preparation, runtime implementation, endpoint implementation, endpoint service, HTTP server, CLI command, watcher, network service, port binding, transport, inbox write, outbox import, result intake, or live endpoint behavior",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_decision_treated_as_preparation_observation_or_runtime"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_decision_treated_as_report_truth_acceptance_or_payload_validity",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation operator decision treated as report truth, result truth, result acceptance, payload validity, payload fetch, payload materialization, result application, or merge",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_decision_treated_as_report_truth_acceptance_or_payload_validity"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_decision_treated_as_repo_layer_storage_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation operator decision treated as repo mutation, Layer mutation, Layer truth, storage write, or production storage authority",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_decision_treated_as_repo_layer_storage_mutation"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_decision_treated_as_scheduler_dispatch_execution_or_platform",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation operator decision treated as scheduler, runner, repo-agent invocation, dispatch, execution, Platform call, host-local consequence, or activation",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_decision_treated_as_scheduler_dispatch_execution_or_platform"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_decision_treated_as_authority_enclosure_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation operator decision treated as identity authority, seat admission, authority transition, accepted continuity, full Edge enclosure proof, autonomy proof, event-family expansion, implementation authority, or auto-execute",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_decision_treated_as_authority_enclosure_or_auto_execute"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_decision_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation operator decision TUI projection treated as action authority, runtime implementation authority, endpoint implementation authority, mutation authority, dispatch authority, execution authority, or approval",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_decision_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_observation_treated_as_preparation_or_runtime",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation observation/result treated as runtime implementation preparation, runtime implementation, endpoint implementation, endpoint service, HTTP server, CLI command, watcher, network service, port binding, transport, inbox write, outbox import, result intake, or live endpoint behavior",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_observation_treated_as_preparation_or_runtime"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_observation_treated_as_report_truth_acceptance_or_payload_validity",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation observation/result treated as report truth, result truth, result acceptance, payload validity, payload fetch, payload materialization, result application, or merge",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_observation_treated_as_report_truth_acceptance_or_payload_validity"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_observation_treated_as_repo_layer_storage_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation observation/result treated as repo mutation, Layer mutation, Layer truth, storage write, or production storage authority",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_observation_treated_as_repo_layer_storage_mutation"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_observation_treated_as_scheduler_dispatch_execution_or_platform",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation observation/result treated as scheduler, runner, repo-agent invocation, dispatch, execution, Platform call, host-local consequence, or activation",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_observation_treated_as_scheduler_dispatch_execution_or_platform"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_observation_treated_as_authority_enclosure_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation observation/result treated as identity authority, seat admission, authority transition, accepted continuity, full Edge enclosure proof, autonomy proof, event-family expansion, implementation authority, or auto-execute",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_observation_treated_as_authority_enclosure_or_auto_execute"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_preparation_observation_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation preparation observation/result TUI projection treated as action authority, runtime implementation authority, endpoint implementation authority, mutation authority, dispatch authority, execution authority, or approval",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_preparation_observation_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_packet_candidate_treated_as_decision_or_runtime",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation packet candidate treated as runtime implementation packet operator decision, runtime implementation preparation, runtime implementation, endpoint implementation, endpoint service, HTTP server, CLI command, watcher, network service, port binding, transport, inbox write, outbox import, result intake, or live endpoint behavior",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_packet_candidate_treated_as_decision_or_runtime"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_packet_candidate_treated_as_report_truth_acceptance_or_payload_validity",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation packet candidate treated as report truth, result truth, result acceptance, payload validity, payload fetch, payload materialization, result application, or merge",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_packet_candidate_treated_as_report_truth_acceptance_or_payload_validity"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_packet_candidate_treated_as_repo_layer_storage_mutation",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation packet candidate treated as repo mutation, Layer mutation, Layer truth, storage write, or production storage authority",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_packet_candidate_treated_as_repo_layer_storage_mutation"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_packet_candidate_treated_as_scheduler_dispatch_execution_or_platform",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation packet candidate treated as scheduler, runner, repo-agent invocation, dispatch, execution, Platform call, host-local consequence, or activation",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_packet_candidate_treated_as_scheduler_dispatch_execution_or_platform"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_packet_candidate_treated_as_authority_enclosure_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation packet candidate treated as identity authority, seat admission, authority transition, accepted continuity, full Edge enclosure proof, autonomy proof, event-family expansion, implementation authority, or auto-execute",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_packet_candidate_treated_as_authority_enclosure_or_auto_execute"
  }),
  Object.freeze({
    caseId: "edge_report_only_endpoint_runtime_packet_candidate_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Edge report-only endpoint runtime implementation packet candidate TUI projection treated as action authority, runtime implementation authority, endpoint implementation authority, mutation authority, dispatch authority, execution authority, or approval",
    reasonCode: "blocked_case:edge_report_only_endpoint_runtime_packet_candidate_tui_treated_as_action_authority"
  }),
  Object.freeze({
