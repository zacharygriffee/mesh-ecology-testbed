...
export const REQUIRED_REPO_FAMILY_SEAM_OVERCLAIM_CASES = Object.freeze([
  ...
  "repo_agent_outbox_report_repair_request_handoff_operator_decision_treated_as_handoff_delivery_or_invocation",
  "repo_agent_outbox_report_repair_request_handoff_operator_decision_treated_as_import_intake_or_acceptance",
  "repo_agent_outbox_report_repair_request_handoff_operator_decision_treated_as_report_truth_or_payload",
  ...
  "repo_agent_repaired_outbox_report_import_candidate_treated_as_import_permission_or_decision",
  "repo_agent_repaired_outbox_report_import_candidate_treated_as_report_import_or_result_intake",
  "repo_agent_repaired_outbox_report_import_candidate_treated_as_acceptance_truth_or_payload",
  ...
  "repo_agent_repaired_outbox_report_import_observation_treated_as_result_intake_or_acceptance",
  "repo_agent_repaired_outbox_report_import_observation_treated_as_report_truth_or_payload",
  "repo_agent_repaired_outbox_report_import_observation_treated_as_application_merge_mutation_or_storage",
  "repo_agent_repaired_outbox_report_import_observation_treated_as_dispatch_execution_authority_or_auto_execute",
  "repo_agent_repaired_outbox_report_import_observation_treated_as_delivery_read_execution_or_invocation_proof",
  "repo_agent_repaired_outbox_report_import_observation_tui_treated_as_action_authority",
  "repo_agent_repaired_outbox_report_body_visibility_treated_as_result_intake_or_compliance_acceptance",
  "repo_agent_repaired_outbox_report_body_visibility_treated_as_report_truth_or_payload",
  "repo_agent_repaired_outbox_report_body_visibility_treated_as_application_merge_mutation_or_storage",
  "repo_agent_repaired_outbox_report_body_visibility_treated_as_dispatch_execution_authority_or_auto_execute",
  "repo_agent_repaired_outbox_report_body_visibility_tui_treated_as_action_authority",
  "repo_agent_repaired_outbox_report_compliance_review_treated_as_result_intake_or_compliance_acceptance",
  "repo_agent_repaired_outbox_report_compliance_review_treated_as_report_truth_or_payload",
  "repo_agent_repaired_outbox_report_compliance_review_treated_as_application_merge_mutation_or_storage",
  "repo_agent_repaired_outbox_report_compliance_review_treated_as_dispatch_execution_authority_or_auto_execute",
  "repo_agent_repaired_outbox_report_compliance_review_treated_as_agent_correctness_or_repair_success_proof",
  "repo_agent_repaired_outbox_report_compliance_review_tui_treated_as_action_authority",
  "repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_result_intake_or_acceptance",
  "repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_repair_success_truth_or_agent_correctness",
  "repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_report_truth_or_payload",
  "repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_application_merge_mutation_or_storage",
  "repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_dispatch_execution_authority_or_auto_execute",
  "repo_agent_repaired_outbox_report_repair_effectiveness_measurement_tui_treated_as_action_authority",
  "repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_candidate_or_intake",
  "repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_compliance_acceptance_or_result_truth",
  "repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_repair_success_or_agent_correctness",
  "repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_payload_or_layer_truth",
  "repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_application_merge_mutation_or_storage",
  "repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_dispatch_execution_authority_or_auto_execute",
  "repo_agent_repaired_outbox_report_result_intake_readiness_tui_treated_as_action_authority",
...
const REQUIRED_CASES = Object.freeze([
  ...
  Object.freeze({
    caseId: "repo_agent_outbox_report_repair_request_handoff_operator_decision_treated_as_handoff_delivery_or_invocation",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent outbox report repair request handoff operator decision treated as handoff attempt, repair request delivery, prompt delivery, inbox write, repo-agent invocation, scheduling, launch, dispatch, execution, Platform call, or host-local consequence",
    reasonCode: "blocked_case:repo_agent_outbox_report_repair_request_handoff_operator_decision_treated_as_handoff_delivery_or_invocation"
  }),
  Object.freeze({
    caseId: "repo_agent_outbox_report_repair_request_handoff_operator_decision_treated_as_import_intake_or_acceptance",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent outbox report repair request handoff operator decision treated as outbox read, report import, result-intake creation, result acceptance, report acceptance, additional operator decision capture, or approval beyond handoff permission",
    reasonCode: "blocked_case:repo_agent_outbox_report_repair_request_handoff_operator_decision_treated_as_import_intake_or_acceptance"
  }),
  Object.freeze({
    caseId: "repo_agent_outbox_report_repair_request_handoff_operator_decision_treated_as_report_truth_or_payload",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent outbox report repair request handoff operator decision treated as report truth, report body truth, agent correctness proof, payload validity, payload fetch, payload materialization, Layer truth, or Layer continuity",
    reasonCode: "blocked_case:repo_agent_outbox_report_repair_request_handoff_operator_decision_treated_as_report_truth_or_payload"
  }),
  Object.freeze({
    caseId: "repo_agent_outbox_report_repair_request_handoff_operator_decision_treated_as_application_merge_mutation_or_storage",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent outbox report repair request handoff operator decision treated as result application, merge, repo mutation, Layer mutation, or storage write",
    reasonCode: "blocked_case:repo_agent_outbox_report_repair_request_handoff_operator_decision_treated_as_application_merge_mutation_or_storage"
  }),
  Object.freeze({
    caseId: "repo_agent_outbox_report_repair_request_handoff_operator_decision_treated_as_authority_event_auto_execute_or_enclosure",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent outbox report repair request handoff operator decision treated as authority transition, accepted continuity, event-family expansion, auto-execute, full Edge enclosure proof, autonomy proof, or wall-clock proof",
    reasonCode: "blocked_case:repo_agent_outbox_report_repair_request_handoff_operator_decision_treated_as_authority_event_auto_execute_or_enclosure"
  }),
  Object.freeze({
    caseId: "repo_agent_outbox_report_repair_request_handoff_operator_decision_tui_treated_as_action_authority",
    sourceFamily: "edge",
  ...
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_import_candidate_treated_as_import_permission_or_decision",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report import candidate treated as import permission, import operator decision creation, operator decision capture, or operator decision approval",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_import_candidate_treated_as_import_permission_or_decision"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_import_candidate_treated_as_report_import_or_result_intake",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report import candidate treated as repaired report read, report import, import observation/result creation, result-intake candidate creation, or result-intake creation",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_import_candidate_treated_as_report_import_or_result_intake"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_import_candidate_treated_as_acceptance_truth_or_payload",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report import candidate treated as result acceptance, report truth, report body truth, payload validity, payload fetch, payload materialization, Layer truth, or Layer continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_import_candidate_treated_as_acceptance_truth_or_payload"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_import_candidate_treated_as_application_merge_mutation_or_storage",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report import candidate treated as result application, merge, repo mutation, Layer mutation, or storage write",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_import_candidate_treated_as_application_merge_mutation_or_storage"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_import_candidate_treated_as_dispatch_execution_authority_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report import candidate treated as scheduling, launch, agent invocation, dispatch, execution, Platform call, host-local consequence, authority transition, event-family expansion, auto-execute, or full Edge enclosure proof",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_import_candidate_treated_as_dispatch_execution_authority_or_auto_execute"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_import_candidate_tui_treated_as_action_authority",
    sourceFamily: "edge",
  ...
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_import_observation_treated_as_result_intake_or_acceptance",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report import observation/result treated as result-intake candidate creation, result intake, compliance acceptance, result acceptance, or accepted continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_import_observation_treated_as_result_intake_or_acceptance"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_import_observation_treated_as_report_truth_or_payload",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report import observation/result treated as reported result truth, report body truth, payload validity, payload fetch, payload materialization, Layer truth, or Layer continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_import_observation_treated_as_report_truth_or_payload"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_import_observation_treated_as_application_merge_mutation_or_storage",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report import observation/result treated as result application, merge, repo mutation, Layer mutation, or storage write",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_import_observation_treated_as_application_merge_mutation_or_storage"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_import_observation_treated_as_dispatch_execution_authority_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report import observation/result treated as scheduling, launch, agent invocation, dispatch, execution, Platform call, host-local consequence, authority transition, event-family expansion, auto-execute, or full Edge enclosure proof",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_import_observation_treated_as_dispatch_execution_authority_or_auto_execute"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_import_observation_treated_as_delivery_read_execution_or_invocation_proof",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report import observation/result treated as repair request delivery proof, agent read proof, execution proof, agent invocation proof, or repaired report correctness proof",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_import_observation_treated_as_delivery_read_execution_or_invocation_proof"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_import_observation_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report import observation/result TUI visibility treated as action authority, result-intake action, acceptance authority, mutation authority, dispatch authority, or execution authority",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_import_observation_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_body_visibility_treated_as_result_intake_or_compliance_acceptance",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report body visibility treated as result-intake candidate creation, result intake, compliance acceptance, result acceptance, or accepted continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_body_visibility_treated_as_result_intake_or_compliance_acceptance"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_body_visibility_treated_as_report_truth_or_payload",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report body visibility treated as reported result truth, report body truth, payload validity, payload fetch, payload materialization, Layer truth, or Layer continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_body_visibility_treated_as_report_truth_or_payload"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_body_visibility_treated_as_application_merge_mutation_or_storage",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report body visibility treated as result application, merge, repo mutation, Layer mutation, or storage write",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_body_visibility_treated_as_application_merge_mutation_or_storage"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_body_visibility_treated_as_dispatch_execution_authority_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report body visibility treated as scheduling, launch, agent invocation, dispatch, execution, Platform call, host-local consequence, authority transition, event-family expansion, auto-execute, or full Edge enclosure proof",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_body_visibility_treated_as_dispatch_execution_authority_or_auto_execute"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_body_visibility_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report body visibility TUI projection treated as action authority, result-intake action, compliance acceptance authority, mutation authority, dispatch authority, or execution authority",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_body_visibility_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_compliance_review_treated_as_result_intake_or_compliance_acceptance",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report compliance review treated as result-intake candidate creation, result intake, compliance acceptance, result acceptance, or accepted continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_compliance_review_treated_as_result_intake_or_compliance_acceptance"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_compliance_review_treated_as_report_truth_or_payload",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report compliance review treated as reported result truth, report body truth, payload validity, payload fetch, payload materialization, Layer truth, or Layer continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_compliance_review_treated_as_report_truth_or_payload"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_compliance_review_treated_as_application_merge_mutation_or_storage",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report compliance review treated as result application, merge, repo mutation, Layer mutation, or storage write",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_compliance_review_treated_as_application_merge_mutation_or_storage"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_compliance_review_treated_as_dispatch_execution_authority_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report compliance review treated as scheduling, launch, agent invocation, dispatch, execution, Platform call, host-local consequence, authority transition, event-family expansion, auto-execute, or full Edge enclosure proof",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_compliance_review_treated_as_dispatch_execution_authority_or_auto_execute"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_compliance_review_treated_as_agent_correctness_or_repair_success_proof",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report compliance review treated as external agent correctness proof, repair success truth, report correctness proof, or delivery/read/execution proof",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_compliance_review_treated_as_agent_correctness_or_repair_success_proof"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_compliance_review_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report compliance review TUI projection treated as action authority, result-intake action, compliance acceptance authority, mutation authority, dispatch authority, or execution authority",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_compliance_review_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_result_intake_or_acceptance",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report repair effectiveness measurement treated as result-intake candidate creation, result intake, compliance acceptance, result acceptance, or accepted continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_result_intake_or_acceptance"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_repair_success_truth_or_agent_correctness",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report repair effectiveness measurement treated as repair success truth, external agent correctness proof, report correctness proof, full Edge enclosure proof, or delivery/read/execution proof",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_repair_success_truth_or_agent_correctness"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_report_truth_or_payload",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report repair effectiveness measurement treated as reported result truth, report body truth, payload validity, payload fetch, payload materialization, Layer truth, or Layer continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_report_truth_or_payload"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_application_merge_mutation_or_storage",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report repair effectiveness measurement treated as result application, merge, repo mutation, Layer mutation, or storage write",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_application_merge_mutation_or_storage"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_dispatch_execution_authority_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report repair effectiveness measurement treated as scheduling, launch, agent invocation, dispatch, execution, Platform call, host-local consequence, authority transition, event-family expansion, or auto-execute",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_repair_effectiveness_measurement_treated_as_dispatch_execution_authority_or_auto_execute"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_repair_effectiveness_measurement_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report repair effectiveness measurement TUI projection treated as action authority, result-intake action, compliance acceptance authority, mutation authority, dispatch authority, or execution authority",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_repair_effectiveness_measurement_tui_treated_as_action_authority"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_candidate_or_intake",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake readiness treated as result-intake candidate creation, result-intake operator decision creation, result intake, or result-intake performance",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_candidate_or_intake"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_compliance_acceptance_or_result_truth",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake readiness treated as compliance acceptance, result acceptance, reported result truth, report body truth, or accepted continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_compliance_acceptance_or_result_truth"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_repair_success_or_agent_correctness",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake readiness treated as repair success truth, external agent correctness proof, report correctness proof, full Edge enclosure proof, or delivery/read/execution proof",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_repair_success_or_agent_correctness"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_payload_or_layer_truth",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake readiness treated as payload validity, payload fetch, payload materialization, Layer truth, or Layer continuity",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_payload_or_layer_truth"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_application_merge_mutation_or_storage",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake readiness treated as result application, merge, repo mutation, Layer mutation, or storage write",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_application_merge_mutation_or_storage"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_dispatch_execution_authority_or_auto_execute",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake readiness treated as scheduling, launch, agent invocation, dispatch, execution, Platform call, host-local consequence, authority transition, event-family expansion, or auto-execute",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_readiness_treated_as_dispatch_execution_authority_or_auto_execute"
  }),
  Object.freeze({
    caseId: "repo_agent_repaired_outbox_report_result_intake_readiness_tui_treated_as_action_authority",
    sourceFamily: "edge",
    attemptedOverclaim: "Repo-agent repaired outbox report result-intake readiness TUI projection treated as action authority, result-intake action, compliance acceptance authority, mutation authority, dispatch authority, or execution authority",
    reasonCode: "blocked_case:repo_agent_repaired_outbox_report_result_intake_readiness_tui_treated_as_action_authority"
  }),
  Object.freeze({
